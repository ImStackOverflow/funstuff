...
//         System.out.println("finding "+startCol+" "+startRow+" "+destCol+" "+destRow);
...
//         System.out.println("found invalid");
  ...
  // function that returns copy of queen
  // Input: nothing
  // Output: reference to copy of this
  public ChessPiece copy()
  {
      Queen theCopy = new Queen(this.getRow(), this.getCol(), this.getColor());
      return theCopy;
  }
