//----------------------------------------------------------------------------- //   IntegerLinkedList.c //   Implementation file for IntegerLinkedList ADT //----------------------------------------------------------------------------- 
#include<stdio.h> 
#include<stdlib.h> 
#include<string.h>
#include<assert.h> 
...
// Node 
//see .h file for defn   
// newNode() // constructor of the Node type 
Node newNode(int x) {    
...
Node find(int number, LinkedList S){
	Node asshole = S->top;
	while (asshole != NULL){
		if (asshole->item == number)	return asshole;
		asshole = asshole->next;
	}
	return NULL;
